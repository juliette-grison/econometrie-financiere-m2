...
```{r}
# Cours
plot.xts(UBI.PA[,4],legend.loc = "topleft", main = "Cours de l'indice UBI.PA", col = "slateblue4")

# Rentabilités
plot.xts(creturn,legend.loc = "topleft", main = "Rentabilités du UBI.PA", col = "skyblue1")
```
...
plot.xts(creturn2,legend.loc = "top", main = "Rentabilités au carré du UBI.PA", col = "lightcyan3")
```
...
table.Autocorrelation(creturn, max.lag = 10)
table.Autocorrelation(creturn2, max.lag = 10)
...
h <- b-1027+1		# nbre observations des rentabilités en 2025
